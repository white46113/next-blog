      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Tech Blog</h3>
            <p className="text-gray-600 mb-4">
              Discover the latest insights, tutorials, and news in technology and development. 
              Stay updated with the ever-evolving world of tech.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/posts" className="text-gray-600 hover:text-gray-900">All Posts</a></li>
