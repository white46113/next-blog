...
export const metadata: Metadata = {
    ...
    description: "Privacy Policy for Tech Blog - Learn how we handle your data and protect your privacy.",
    alternates: {
        ...
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto px-4 py-12 max-w-4xl">
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                    <h2>Introduction</h2>
                    <p>
                        Welcome to Tech Blog ("we," "our," or "us"). We are committed to protecting your privacy.
                        This Privacy Policy explains how we collect, use, and safeguard your information when you visit
                        our website at <Link href="/" className="text-primary hover:underline">tech.weebcoder.com</Link>.
                    </p>
                    ...
                    <p>We use cookies and similar tracking technologies. Types of cookies we use:</p>
                    <ul>
                    ...
                    <p>
                        We use Google Analytics to analyze website traffic. For more information, visit{" "}
                    ...
                    <p>
                        We use Google AdSense to display advertisements. You can opt out of personalized advertising by visiting{" "}
                    ...
                    <p>
                        Our website is not intended for children under 13. If you believe we have collected information from a child
