...
import { ArrowLeft, Wrench, Mail, MessageSquare } from "lucide-react";
import type { Metadata } from "next";

export const metadata: Metadata = {
    title: "Contact Us | WeebCoder Tools",
    description: "Get in touch with WeebCoder Tools.",
    alternates: {
        canonical: "https://tools.weebcoder.com/contact",
    },
};
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <main className="container mx-auto px-4 py-12 max-w-4xl">
                ...
                <p className="text-xl text-muted-foreground mb-12">Have questions or tool requests? We'd love to hear from you!</p>
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-12">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>For inquiries or tool requests</CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <ul>
                        <li>Tool requests and suggestions</li>
