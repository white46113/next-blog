...
const TOOLS_APP_URL = "https://tools.weebcoder.com";

const allTools: Tool[] = [
    { name: "BMI Calculator", href: `${TOOLS_APP_URL}/tools/bmi-calculator`, description: "Calculate your Body Mass Index", category: "Calculator", icon: Calculator },
    { name: "Percentage Calculator", href: `${TOOLS_APP_URL}/tools/percentage-calculator`, description: "Calculate percentages easily", category: "Calculator", icon: Percent },
    { name: "Crop Image", href: `${TOOLS_APP_URL}/tools/crop-image`, description: "Crop images to exact dimensions with aspect ratios", category: "Converter", icon: Crop },
    { name: "JPG to PDF", href: `${TOOLS_APP_URL}/tools/jpg-to-pdf`, description: "Convert JPG images to PDF", category: "Converter", icon: FileImage },
    { name: "PDF to Image", href: `${TOOLS_APP_URL}/tools/pdf-to-image`, description: "Convert PDF to PNG/JPEG/WebP", category: "Converter", icon: FileImage },
    { name: "PNG to WebP", href: `${TOOLS_APP_URL}/tools/png-to-webp`, description: "Convert PNG to modern WebP format", category: "Converter", icon: FileImage },
    { name: "QR Code Generator", href: `${TOOLS_APP_URL}/tools/qr-code-generator`, description: "Generate QR codes instantly", category: "Generator", icon: QrCode },
    { name: "YouTube Thumbnail Downloader", href: `${TOOLS_APP_URL}/tools/youtube-thumbnail-downloader`, description: "Download YouTube thumbnails in HD", category: "Downloader", icon: Download },
    { name: "HTTP Request Tester", href: `${TOOLS_APP_URL}/tools/form-data-debugger`, description: "Test APIs online - Postman alternative", category: "Developer", icon: Bug },
    { name: "SEO Crawler", href: `${TOOLS_APP_URL}/tools/seo-crawler`, description: "Find indexing issues on your site", category: "Developer", icon: Search },
